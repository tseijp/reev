...
export const CellaImpl = React.forwardRef((props: CellaProps, ref: any) => {
        ...
        if (!i)
                return (
                        <group ref={ref} {...other}>
                                <mesh castShadow position={[4 / l, 4 / l, 4 / l]} scale={[2 / l, 2 / l, 2 / l]}>
                                        {/* @ts-ignore */}
                                        <mat color={color} />
        ...
        return (
                <group ref={ref} {...other}>
                        <mesh castShadow position={[px(i, l), py(i, l), pz(i, l)]} scale={[sx(i, l), sy(i, l), sz(i, l)]}>
                                {/* @ts-ignore */}
                                <mat color={color} />
                                <boxGeometry args={[1, 1, 1]} />
                        </mesh>
                        <mesh castShadow position={[pz(i, l), px(i, l), py(i, l)]} scale={[sz(i, l), sx(i, l), sy(i, l)]}>
                                {/* @ts-ignore */}
                                <mat color={color} />
                                <boxGeometry args={[1, 1, 1]} />
                        </mesh>
                        <mesh castShadow position={[py(i, l), pz(i, l), px(i, l)]} scale={[sy(i, l), sz(i, l), sx(i, l)]}>
                                {/* @ts-ignore */}
                                <mat color={color} />
                                <boxGeometry args={[1, 1, 1]} />
                        </mesh>
